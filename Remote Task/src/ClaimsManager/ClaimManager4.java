...
class Claim4 {
    ...
    public Claim4(int id, String clientName, double amount, String claimText, String date) {
        this.id = id;
...
public class ClaimManager4 {
    ...
    public static void main(String[] args) {
        ...
        for (Map.Entry<String, List<Claim>> entry : categorizedClaims.entrySet()) {
            ...
            String categoryName = entry.getKey().toUpperCase();

            System.out.println(categoryName + " claims:");
            for (Claim claim : entry.getValue()) {
                System.out.println("Claim ID: " + claim.getId() + ", Date: " + claim.getDate() + ", Customer Name: " + claim.getClientName());
            }
            System.out.println();
        }
    }
