...
class TeamMember3 {
    ...
    public TeamMember3(String name, int qualityOfWork, int productivity, int communication, int hoursPerWeek, boolean hasChildren, int yearsWorking, int age) {
        this.name = name;
...
public class TeamPerformanceManager3 {
