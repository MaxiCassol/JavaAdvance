...
class TeamMember1 {
    ...
    public TeamMember1(String name, int qualityOfWork, int productivity, int communication, int hoursPerWeek, boolean hasChildren, int yearsWorking, int age) {
        this.name = name;
...
public class TeamPerformanceManager1 {
    ...
    // Variables to bonus-eligible members and bonus amount
