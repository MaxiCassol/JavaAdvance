...
public class Product {
    ...
    public void setQuantitySold(int quantitySold) {
        if (quantitySold < 0) {
            throw new IllegalArgumentException("The Quantity sold cannot be negative!");
        }
        this.quantitySold = quantitySold;
    }
    ...
    public static List<From_CSV_to_Products.e.Product> readCSV(String filePath) throws IOException, ParseException {
        List<From_CSV_to_Products.e.Product> productList = new ArrayList<>();
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                From_CSV_to_Products.e.Product product = new From_CSV_to_Products.e.Product(name, category, price, quantitySold, date);
    ...
    public static List<From_CSV_to_Products.e.Product> removeDuplicates(List<From_CSV_to_Products.e.Product> productList) {
        Set<From_CSV_to_Products.e.Product> uniqueProducts = new LinkedHashSet<>(productList);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || getClass() != obj.getClass())
            return false;
        From_CSV_to_Products.e.Product other = (From_CSV_to_Products.e.Product) obj;
